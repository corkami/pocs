; PE importing by ordinal (his own exports)

; Ange Albertini, BSD LICENCE 2011-2011
...
impbyord.exe_iat:
__imp__export:
    dd impbyord.exe_hintnames - IMAGEBASE
    dd 0
_d
...
;impbyord.exe_DESCRIPTOR:
    dd impbyord.exe_hintnames - IMAGEBASE
    dd 0
    dd 0
    dd impbyord.exe - IMAGEBASE
    dd impbyord.exe_iat - IMAGEBASE
...
impbyord.exe db 'impbyord.exe', 0
